-- =====================================================================
-- STORE BOOTSTRAP — full schema for a brand new project
-- Creates: all tables, enums, functions, RLS policies, and defaults.
-- =====================================================================
...
-- Media storage policies (bucket is created separately via the storage tool)
...
-- 3. Final place_order with variant support + zone shipping (COD per-zone charge)
