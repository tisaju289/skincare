import skincareHeroRitual from "@/assets/skincare-hero-ritual.jpg";
import skincareHeroHydration from "@/assets/skincare-hero-hydration.jpg";
import skincareHeroRenewal from "@/assets/skincare-hero-renewal.jpg";
...
export const DEFAULT_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    badge: "NEW RITUAL",
    title: "Care that begins with nature",
    subtitle: "Thoughtful formulas for calm, resilient and luminous skin.",
    image: skincareHeroRitual,
    cta_label: "Explore the ritual",
    cta_link: "/search",
  },
  {
    kicker: "HYDRATION, REFINED",
    badge: "DAILY CARE",
    title: "A softer way to replenish",
    subtitle: "Weightless hydration created for Bangladesh's climate.",
    image: skincareHeroHydration,
    cta_label: "Shop hydration",
    cta_link: "/search",
  },
  {
    kicker: "NIGHTLY RENEWAL",
    badge: "EDITOR'S PICK",
    title: "Let your barrier breathe",
    subtitle: "Nourishing essentials for a balanced evening routine.",
    image: skincareHeroRenewal,
    cta_label: "Build your routine",
    cta_link: "/search",
  },
];
...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  og_image_url: null,
  announcement_text:
    "Authentic skincare · Cash on delivery across Bangladesh",
  announcement_enabled: true,
  announcement_link: null,
  announcement_bg: "#253329",
  announcement_text_color: "#faf9f4",
  facebook_url: null,
  instagram_url: null,
  youtube_url: null,
  seo_title: "The Skin Edit — Modern Skincare in Bangladesh",
  seo_description:
    "Discover authentic skincare and thoughtful daily rituals with cash on delivery across Bangladesh.",
  seo_keywords: "skincare, authentic skincare, beauty, bangladesh",
  theme_pink: "#b58a43",
  theme_magenta: "#d9dfcc",
  theme_purple: "#253329",
  theme_teal: "#658171",
  theme_green: "#526a58",
  pay_bkash: true,
